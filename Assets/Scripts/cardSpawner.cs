...
public class cardSpawner : MonoBehaviour
{
    ...
    public void gameover()
    {
        ...
        mistakes_copy[Array.IndexOf(mistakes_copy, mistakes[0])] = -1; // prevents using the same card again
    ...
    public void review_next() // to review the next error
    {
        ...
        if (review_idx == 3) // this means that the maximum of 3 reviews has been hit. redirects player to the score page.
        {
            SeeScore();
            return;
        }
